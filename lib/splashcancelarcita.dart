...
class SplashAppCC extends StatelessWidget {
  @override
...
class SplashScreenCC extends StatefulWidget {
  @override
  SplashScreenState createState() => new SplashScreenState();
}

class SplashScreenState extends State<SplashScreenCC>
  ...
  void navigationPage() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => VisVacio()));
  }
